...
@Component({
  selector: 'sl-hlines',
  templateUrl: './hlines.component.html',
  styleUrls: ['./hlines.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class HlinesComponent implements OnInit, AfterViewInit {
